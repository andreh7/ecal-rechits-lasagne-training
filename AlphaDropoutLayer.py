...
# from https://github.com/rfratila/Lasagne/blob/33ca51aa95e6e184d9e1d50b8093a0670014e535/lasagne/layers/noise.py#L21
# from pull request https://github.com/Lasagne/Lasagne/pull/855

class NewDropoutLayer(Layer):
    """Dropout layer
    ...
    def __init__(self, incoming, p=0.5, rescale=True, shared_axes=(),
                 **kwargs):
        super(NewDropoutLayer, self).__init__(incoming, **kwargs)
...
#----------------------------------------------------------------------
# from https://github.com/rfratila/Lasagne/blob/33ca51aa95e6e184d9e1d50b8093a0670014e535/lasagne/layers/noise.py#L227
# from pull request https://github.com/Lasagne/Lasagne/pull/855


class AlphaDropoutLayer(NewDropoutLayer):
    """Dropout layer.

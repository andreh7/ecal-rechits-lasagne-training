...
def datasetLoadFunction(fnames, size, cuda, isTraining, reweightPtEta, logStreams, returnEventIds, 
    ...
    from datasetutilsnpy import makeTracksConcatenator, makeRecHitsConcatenator, CommonDataConcatenator, SimpleVariableConcatenator, PtEtaReweighter
    ...
    print "UU",data['phoVars/maxRecHitEta']

...
datasetDir = '../data/2016-05-larger-window'

isBarrel = True

dataDesc = dict(

    train_files = [ datasetDir + '/GJet20to40/rechits-barrel-train.t7',
                    datasetDir + '/GJet20toInf/rechits-barrel-train.t7',
                    datasetDir + '/GJet40toInf/rechits-barrel-train.t7',
                    ],

    test_files  = [ datasetDir + '/GJet20to40/rechits-barrel-test.t7',
                    datasetDir + '/GJet20toInf/rechits-barrel-test.t7',
                    datasetDir + '/GJet40toInf/rechits-barrel-test.t7'
                    ],
